document.addEventListener('DOMContentLoaded', function() {
    ...
    // Added a local debounce utility to prevent synchronous main-thread blocking when filtering lists.
    // This optimization is applied to various search inputs (validator, game, flash sale game) to reduce
    // heavy filtering operations and DOM repaints while the user is typing rapidly.
