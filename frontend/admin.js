...
if (marginForm) {
    ...
    if (validatorSearchInput) {
        const handleValidatorSearch = debounce(() => {
        ...
        validatorSearchInput.addEventListener('input', handleValidatorSearch);
}
            }
...
if (promosTableBody) {
    ...
    if (gameSearchInput) {
        const handleGameSearch = debounce(() => {
...
if (fsGameSearch) {
    const handleFsGameSearch = debounce(() => {
    ...
    fsGameSearch.addEventListener('input', handleFsGameSearch);
}
